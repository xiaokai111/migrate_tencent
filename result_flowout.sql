...
-- ----------------------------
-- Table structure for result_flowout
-- ----------------------------
DROP TABLE IF EXISTS `result_flowout`;
CREATE TABLE `result_flowout` (
  ...
  `bus_proportion` float(3,2) NOT NULL COMMENT '公交车百分比',
  `train_persontime` int(255) NOT NULL COMMENT '火车人次',
  `train_proportion` float(3,2) NOT NULL COMMENT '火车人次百分比',
  `airplane_persontime` int(11) NOT NULL COMMENT '飞机人次',
  `airplane_proportion` float(3,2) NOT NULL COMMENT '飞机占比',
